      ...
      <section className="w-full bg-[#f4f0eb]">
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="flex-1">
            <img
              src={HC_IMG.appPromo}
              alt="App Thành Viên HighlandsĐI"
          ...
          <div className="flex flex-1 flex-col items-center justify-center bg-[#f4f0eb] px-10 py-16 md:py-24 text-center">
            <h2 className="text-[38px] font-bold leading-tight text-[#333333] md:text-[42px]">
              App Thành Viên<br />HighlandsĐI
            </h2>
            <p className="mt-4 text-base font-medium text-gray-700">
              Đặt trước - Lấy ngay, không cần đợi
            </p>
            <button
              type="button"
      ...
      <section className="w-full bg-white py-16">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6">
          <h2 className="mb-12 text-center text-3xl font-bold text-[#333333] md:text-[38px]">
            Đồng Hành Cùng Avengers
          </h2>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              { img: HC_IMG.dongHanh1, label: 'ĐẶT HÀNG NGAY', action: 'order' },
              { img: HC_IMG.dongHanh2, label: 'CƠ HỘI NGHỀ NGHIỆP', action: 'stores' },
              { img: HC_IMG.dongHanh3, label: 'TIN TỨC', action: 'news' },
            ].map((item, idx) => (
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            >
              ...
              <div className="bg-[#f9f4ec] group-hover:bg-[#b22830] transition-colors duration-300 rounded-b-[20px] py-8 w-full flex items-center justify-center">
                 <p className="text-center text-[18px] font-bold uppercase tracking-wide text-[#333333] group-hover:text-white transition-colors duration-300">NƯỚC NGON THƯỞNG VỊ</p>
              </div>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <div className="bg-[#f9f4ec] group-hover:bg-[#b22830] transition-colors duration-300 rounded-b-[20px] py-8 w-full flex items-center justify-center">
                 <p className="text-center text-[18px] font-bold uppercase tracking-wide text-[#333333] group-hover:text-white transition-colors duration-300">BÁNH NGON NO ĐẦY</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <section className="w-full bg-white mt-10">
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-10 py-16 md:py-24 text-center bg-[#f9f4ec]">
            <h2 className="text-[38px] font-bold leading-tight text-[#333333] md:text-[42px]">
              Cửa Hàng<br />Avengers Gần Bạn
            </h2>
            <p className="mt-4 text-[15px] font-medium text-[#555555]">
              Bạn ở đâu, có Avengers ở đó!
            </p>
            <button
              type="button"
