...
export default function NewsPage({ onSelectArticle }) {
  ...
  return (
    <div className="w-full bg-white mt-0 min-h-screen">
      {/* Top Banner Header */}
      <div className="bg-[#5e0b0f] text-white py-12 px-4 shadow-md">
        <div className="max-w-[1200px] mx-auto text-center space-y-3">
          <div className="inline-flex items-center gap-2 bg-white/15 px-4 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-widest text-white border border-white/20">
