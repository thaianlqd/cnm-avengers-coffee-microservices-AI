        ...
        <main style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <header style={{
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              {/* LIVE SHIFT BADGE IN HEADER */}
              {activeKioskShift?.has_open_shift ? (
                <div style={{
                  padding: '6px 14px', borderRadius: 99, background: '#ecfdf5', border: '1px solid #a7f3d0',
                  color: '#065f46', fontSize: 12, fontWeight: 800, display: 'flex', alignItems: 'center', gap: 8,
                  boxShadow: '0 2px 8px rgba(16,185,129,0.15)'
                }}>
                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#10b981', display: 'inline-block' }}></span>
                  <span>Ca đang mở: <b>{activeKioskShift.active_shift?.staff_name}</b> ({fmtMoney(activeKioskShift.live_stats?.total_revenue)} • {activeKioskShift.live_stats?.total_orders} đơn)</span>
                </div>
              ) : (
                <div style={{
                  padding: '6px 14px', borderRadius: 99, background: '#fef2f2', border: '1px solid #fecaca',
                  color: '#991b1b', fontSize: 12, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 6
                }}>
                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#ef4444', display: 'inline-block' }}></span>
                  <span>Kiosk chưa mở ca</span>
                </div>
              )}
